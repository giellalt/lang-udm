...
Words from lexicon __PROP_HEIMONNIMET__ are "old" tribe and place names, 
which have an optional infix for some cases, while some do not.

In __HEIMO_SUFFIXES_LA__, we append the cases with their post-ла realizations.
Examples:
|   Case    |  Infix | No infix
| --- | --- | --- 
|  Iness.     |  Салья-ла-н    |  Салья-ын
...
In __HEIMO_SUFFIXES_NIL__, the word gets cases with no infix.

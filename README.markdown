...
This directory contains source files for the Udmurt language morphology
...
In order to compile and use Udmurt language morphology and dictionaries,
you need:
...
The Udmurt language sources can be acquired using [giella SVN
